...
export default function Credits() {
    ...
    return (   
        <div style={{color: 'white'}}>
            <h1>Credits</h1>
            <h4>Designed and built by Neil Brooks</h4>
            <h2>Image credits</h2>
            <h4>All credit to panoramic views goes to Blockade Labs for their AI tool Skybox (https://skybox.blockadelabs.com/) </h4>
            <h2>Sound credits</h2>
            <h4>All ambient sounds specifically designated by uploader as creative commons - noncommercial use with attribution.</h4>
            <h4>Amibilia: "RElaxing Nature Ambience Meditation - Good Morning Spring Nature Therapy" by Aziz (https://www.youtube.com/watch?v=4sqgvqhxbOE)</h4>
